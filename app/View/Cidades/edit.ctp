...
<div class="ym-column">
    ...
    <h4 class="ym-fbox-heading"><?php echo __('Editar Cidade'); ?></h4>
    ...
    <div class="ym-col3" >
        ...
        <div class="actions ym-cbox">
	        <h4><?php echo __('Ações'); ?></h4>
        		        ...
        		        <?php echo $this->Form->postLink(__('Excluir'), array('action' => 'delete', $this->Form->value('Cidade.id')), array('class'=>'ym-button'), __('Você tem certeza que deseja excluir o # %s?', $this->Form->value('Cidade.id'))); ?>        		        <?php echo $this->Html->link(__('Listar Cidades'), array('action' => 'index'), array('class'=>'ym-button'));?>        <?php echo __('<h6>Estados</h6>'); ?>		<?php echo $this->Html->link(__('Listar Estados'), array('controller' => 'estados', 'action' => 'index'), array('class'=>'ym-button')); ?> 
