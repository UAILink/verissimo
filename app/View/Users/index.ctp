<div class="ym-column">
	...
	<tr>
		...
		<td><?php echo $this->Formatacao->data($user['User']['created']); ?>&nbsp;</td>
		<td><?php echo $this->Formatacao->data($user['User']['modified']); ?>&nbsp;</td>
		<td class="actions">
    ...
    <div class="ym-col3">
        <div class="actions ym-cbox">
	        <h3><?php echo __('Ações'); ?></h3>
		        ...
		        <?php echo $this->Html->link(__('Novo Usuário'), array('action' => 'add'), array('class'=>'ym-button')); ?>        	        </ul>
        </div>
    </div>
</div>
